...
namespace HistoryBlastrV1
{
    public partial class frmHistoryblastr : Form
    {
        ...
        private void checkanswers()
        {
            ...
            lbNameone.Text = timeline.GetNameBySpot(_correctOrdererOfItems[0]);
            lbNametwo.Text = timeline.GetNameBySpot(_correctOrdererOfItems[1]);
            lbNamethree.Text = timeline.GetNameBySpot(_correctOrdererOfItems[2]);
            lbNamefour.Text = timeline.GetNameBySpot(_correctOrdererOfItems[3]);
            lbNamefive.Text = timeline.GetNameBySpot(_correctOrdererOfItems[4]);
        ...
        private void checktime()
        {
            ...
            correcttime2 = timeline.GetTimeBySpot(chosenSpot2);
            correcttime3 = timeline.GetTimeBySpot(chosenSpot3);
            correcttime4 = timeline.GetTimeBySpot(chosenSpot4);
            correcttime5 = timeline.GetTimeBySpot(chosenSpot5);
        ...
        private void frmHistoryblastr_FormClosing(object sender, FormClosingEventArgs e)
        {
            music.Stop();
        }
        ...
        {
            if (rbHistorischeTekening.Checked)
            {
                Image backgroundImage = new Bitmap(Properties.Resources.HistoryBackground);
                this.BackgroundImage = backgroundImage;
                this.BackgroundImageLayout = ImageLayout.Stretch;
            }
            if (rbSovjet.Checked)
            {
                Image backgroundImage = new Bitmap(Properties.Resources.Sovjet);
                this.BackgroundImage = backgroundImage;
                this.BackgroundImageLayout = ImageLayout.Stretch;
            }
        }
        public void ChooseCursor()
        {
            if (rbDino.Checked)
            {
                this.Cursor = new Cursor(Application.StartupPath + "\\DinoCursor.ico");
            }
        }
        public void ChooseSong()
        {
            if (rbHistoryBlastr.Checked)
            {
                music = new System.Media.SoundPlayer(Properties.Resources.HistoryBlastr___Game_Theme);
            }
            if (rbAstroBlastr.Checked)
            {
                music = new System.Media.SoundPlayer(Properties.Resources.AstroBlaster___Game_Theme__Medieval_Version_);
            }
        }
