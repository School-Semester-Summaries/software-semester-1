...
namespace AstroBlaster
{
    public partial class AstroBlastr : Form
    {
        ...
        private void Restart_Click(object sender, EventArgs e)
        {
            ...
            AllText.AppendLine(txb_Username.Text + "\t" + Speler.Score);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            database.InsertScore(5, "r");
        }
        private void DataBaseConnection_Click(object sender, EventArgs e)
        {
            DatabaseLogic database = new DatabaseLogic();
            database.InsertScore(5, "r");
        }
        ...
        {
            if (txb_Username.Text.Length >= 4 )
            {
                MessageBox.Show("Maximaal 3 Karakters");
                string text = txb_Username.Text;
                string NewText = text.Remove(text.Length - 1, 1);
                txb_Username.Text = NewText;
            }
        }
        ...
        public void ChooseSkin()
        {
            if (RB_Ufo.Checked)
            {
                Image skin = new Bitmap(Properties.Resources.Ufo);
                this.SpaceShip.Image = skin;
                this.SpaceShip.SizeMode = PictureBoxSizeMode.StretchImage;
            }
            if (RB_Dababy.Checked)
            {
                Image skin = new Bitmap(Properties.Resources.Dababy_Convertible);
                this.SpaceShip.Image = skin;
                this.SpaceShip.SizeMode = PictureBoxSizeMode.StretchImage;
            }
        }
        ...
        {
            if (RB_Abstract.Checked)
            {
                Image backgroundImage = new Bitmap(Properties.Resources.Abstract);
                this.BackgroundImage = backgroundImage;
                this.BackgroundImageLayout = ImageLayout.Stretch;
            }
            if (RB_LaserKitty.Checked)
            {
                Image backgroundImage = new Bitmap(Properties.Resources.Kitty);
                this.BackgroundImage = backgroundImage;
                this.BackgroundImageLayout = ImageLayout.Stretch;
            }
        }
        ...
        {
            if (RB_AstroBlastr.Checked)
            {
                music = new System.Media.SoundPlayer(Properties.Resources.AstroBlastr___Game_Theme);
            }
            if (RB_HistoryBlastr.Checked)
            {
                music = new System.Media.SoundPlayer(Properties.Resources.HistoryBlastr___Game_Theme__8_bit_);
            }
        }
        public void SetSom()
        {
