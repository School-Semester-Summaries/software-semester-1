...
namespace KnightsAndWalls
{
    class Bodyguard
    {
        ...
        // ADDITIONAL INFO: DOUBLE DAMAGE ON DEFENCES
        ...
        public void HuntTarget() // error als er nog geen target is
        {
            if (moving)
            {
        ...
        public void SetTarget(List<Cannon> cannonList, List<Townhall> townhallList) // uses upper left corners for distance calculation, try using center points
        {
            ...
            // calculate closest townhall, only if all defences are gone
